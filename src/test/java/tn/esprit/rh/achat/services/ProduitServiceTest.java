...
public class ProduitServiceTest {
    ...
    public void testRetrieveAllProduits() {
        Produit produit1 = new Produit(1L, "produit1","a" ,100.0,20/02/2020,20/05/2020); // Adjust fields based on your Produit entity
        Produit produit2 = new Produit(2L, "produit2","a" ,100.0,20/02/2020,20/05/2020);
...
*/
    ...
    public void testAddProduit() {
        Produit produit = new Produit(1L, "produit1","a" ,100.0,20/02/2020,20/05/2020); // Adjust fields based on your Produit entity
    ...
    public void testUpdateProduit() {
        Produit produit = new Produit(3L, "produit3","a" ,100.0,20/02/2020,20/05/2020); // Adjust fields based on your Produit entity
        Mockito.when(produitRepository.save(produit)).thenReturn(produit);
